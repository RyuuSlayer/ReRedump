            ...
            <div class="hidden lg:flex lg:items-center lg:ms-6">
                @auth
                    <div class="lg:ms-3 relative flex items-center">
                        <a href="https://github.com/RyuuSlayer/ReRedump" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-3 py-2 text-sm text-gray-300 hover:text-gray-100 transition">
                ...
                @else
                    <div class="lg:ms-3 relative flex items-center space-x-4">
                        ...
                        <a href="{{ route('login') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-300 hover:text-gray-100 transition-colors duration-200 ease-in-out">
                            {{ __('Log in') }}
                        </a>
                        <a href="{{ route('register') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-300 hover:text-gray-100 transition-colors duration-200 ease-in-out">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endif
