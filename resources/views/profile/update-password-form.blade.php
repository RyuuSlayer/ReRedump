<x-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="current_password" type="password" class="mt-1 block w-full dark:bg-discord-200 dark:text-gray-300 dark:border-discord-400"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="password" type="password" class="mt-1 block w-full dark:bg-discord-200 dark:text-gray-300 dark:border-discord-400"
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="password_confirmation" type="password" class="mt-1 block w-full dark:bg-discord-200 dark:text-gray-300 dark:border-discord-400"
    ...
    <x-slot name="actions">
        ...
        <x-button class="dark:bg-discord-300 dark:hover:bg-discord-200">
            {{ __('Save') }}
        </x-button>
    </x-slot>
</x-form-section>
