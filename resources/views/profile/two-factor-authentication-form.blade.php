<x-action-section>
    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                <div class="mt-4 p-2 inline-block bg-discord-l-100 dark:bg-discord-d-300">
            ...
            @if ($showingRecoveryCodes)
                ...
                <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-discord-l-100 dark:bg-discord-d-300 rounded-lg">
